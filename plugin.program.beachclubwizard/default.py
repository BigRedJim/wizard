...
base='Beach Club Wizard'
ADDON=xbmcaddon.Addon(id='plugin.program.beachclubwizard')
...
EXCLUDES     = ['plugin.program.beachclubwizard']
HOME         =  xbmc.translatePath('special://home/')

    
def CATEGORIES():
    link = OPEN_URL('https://github.com/BigRedJim/wizard/blob/master/plugin.video.beachclubwizrd/beachclubwizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("Beach Club WIZARD","lets have a good time",'', 'Turn on the engines')
    ...
    time.sleep(2)
    dp.update(0,"", "Extracting your choosen Beach Club Build now, Please Wait")
    print '======================================='
    print addonfolder
    print '======================================='
...
def addDir(name,url,mode,iconimage,fanart,description):
        ...
        ok=True
        liz=xbmcgui.ListItem(name, iconImage="http://skymashi.eu/images/freshstart.png", thumbnailImage=iconimage)
...
def FRESHSTART(params):
    ...
    choice2 = xbmcgui.Dialog().yesno("Are you sure?", 'Are you sure you want to wipe this install?', '', 'All addons EXCLUDING Beach Club WIZARD will be completely wiped!', yeslabel='Yes',nolabel='No')
    if choice2 == 0:
        return
    elif choice2 == 1:
